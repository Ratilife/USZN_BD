...
&НаСервере
Функция РазницаДатНаСервере(ДатаНач, ДатаКон=Неопределено, СтрПериод)   экспорт
...
Функция МинимальнаяВерсияПлатформы() Экспорт // АПК:581
	...
	Возврат "8.3.14.1694; 8.3.15.2107; 8.3.16.1224;8.3.16.1148; 8.3.17.1851; 8.3.18.1208";
