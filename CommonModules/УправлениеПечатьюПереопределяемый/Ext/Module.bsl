...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.Талоны);
	СписокОбъектов.Добавить(Документы.Решение);
	СписокОбъектов.Добавить(Справочники.ФизическиеЛица);
	СписокОбъектов.Добавить(Документы.ЛичноеДело);
	СписокОбъектов.Добавить(Обработки.СписокНаКомиссию);
