...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	Если НЕ ЗначениеЗаполнено(ОбъектПечати) Тогда
		ВызватьИсключение НСтр("ru = 'Не определен объект(письмо или договор), для которого необходимо распечатать текст .'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ШаблонОбъекта) Тогда
		...
		Иначе
			...
			ВызватьИсключение НСтр("ru = 'Не указан шаблон договора или письма для редактирования текста.'");
		КонецЕсли;
...
Процедура ЗагрузитьШаблонОбъекта()
	...
	ПечатьДоговоров.ЗаполнитьТекстОбъектаПоШаблону(ШаблонОбъекта,ОбъектПечати);
	//
